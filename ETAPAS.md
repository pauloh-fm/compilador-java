...
- [ ] Construir uma estrutura de dados que represente a estrutura sintática do programa-fonte.
- [ ] Especificar as classes abstratas e concretas para representar os nós da AST.
- [ ] Adaptar os métodos de análise sintática para construir a árvore durante o processamento do programa-fonte.
- [ ] Prever uma opção que permita ao usuário visualizar a árvore depois de montada.
